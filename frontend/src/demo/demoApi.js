...
const applicants = [{ candidateId: 1001, candidateName: 'Alex Morgan', githubLogin: 'demo.candidate', candidateEmail: 'alex@demo.example', score: 92, jobCandCurrStage: '2y', postId: 9001 }];
