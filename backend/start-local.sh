...
export PYTHON_GITHUB_API_URL="${PYTHON_GITHUB_API_URL:-http://localhost:8100}"
export PYTHON_CHATBOT_API_URL="${PYTHON_CHATBOT_API_URL:-http://localhost:8101}"
export PYTHON_INTERVIEW_API_URL="${PYTHON_INTERVIEW_API_URL:-http://localhost:8102}"
export PYTHON_QUESTIONS_API_URL="${PYTHON_QUESTIONS_API_URL:-http://localhost:8104}"
export PYTHON_MATCHING_API_URL="${PYTHON_MATCHING_API_URL:-http://localhost:8103}"
export MAIL_USERNAME="${MAIL_USERNAME:-}"
export MAIL_PASSWORD="${MAIL_PASSWORD:-}"
export GOOGLE_CLIENT_ID="${GOOGLE_CLIENT_ID:-}"
export GOOGLE_CLIENT_SECRET="${GOOGLE_CLIENT_SECRET:-}"
export GOOGLE_REDIRECT_URI="${GOOGLE_REDIRECT_URI:-http://localhost:3100/google-auth}"
export GITHUB_CLIENT_ID="${GITHUB_CLIENT_ID:-}"
export GITHUB_CLIENT_SECRET="${GITHUB_CLIENT_SECRET:-}"
export GITHUB_REDIRECT_URI="${GITHUB_REDIRECT_URI:-http://localhost:3100/github-auth}"
